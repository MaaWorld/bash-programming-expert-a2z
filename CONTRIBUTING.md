...
1. Check if the bug has already been reported by searching the [Issues](https://github.com/bash-programming-expert-a2z/issues).
...
1. Check if the enhancement has already been suggested by searching the [Issues](https://github.com/bash-programming-expert-a2z/issues).
